...
export const FeedPage: React.FC = () => {
  ...
  }, [products, selectedCategory, searchQuery, priceRange, instantOnly, sortBy]);
            ...
            <div className="flex bg-[#0C2B35] p-1 rounded-xl border border-[#4A7071]/50">
              <button
                ...
                className={`p-2 rounded-lg text-xs transition-colors ${
                  viewMode === 'grid' ? 'bg-[#83B2A8] text-[#09121D]' : 'text-[#CBD6D3] hover:text-white'
                }`}
                title="Grid View"
              >
              ...
              <button
                ...
                className={`p-2 rounded-lg text-xs transition-colors ${
                  viewMode === 'list' ? 'bg-[#83B2A8] text-[#09121D]' : 'text-[#CBD6D3] hover:text-white'
                }`}
                title="List View"
              >
              ...
              <button
                ...
                className={`p-2 rounded-lg text-xs transition-colors ${
                  viewMode === 'map' ? 'bg-[#83B2A8] text-[#09121D]' : 'text-[#CBD6D3] hover:text-white'
                }`}
          ...
          {mockCategories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`px-3.5 py-2 rounded-full text-xs font-semibold flex items-center gap-1.5 whitespace-nowrap transition-all border ${
                  isSelected
              ...
              >
                ...
                <span className={`text-[10px] px-1.5 py-0.2 rounded-full ${
                  isSelected ? 'bg-[#09121D]/20 text-[#09121D]' : 'bg-[#09121D] text-[#83B2A8]'
                }`}>
                  {cat.count}
                </span>
              </button>
